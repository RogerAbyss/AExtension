                                     ...
                                     toDate:(NSDate *)endDate
{
    ...
    for (NSString *unitName in unitChineseArray)
    {
        ...
        {
            NSNumber *number = @(abs([[components valueForKey:[unitPropertyArray objectAtIndex:[unitChineseArray indexOfObject:unitName]]] intValue]));
            // @(abs([components valueForComponent:NSCalendarUnitFromString(unitName)]));
