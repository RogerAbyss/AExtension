...
static NSString* Default_TimeFormat = @"yyyy-MM-dd^ HH:mm:ss";

static int Default_MoneyUnitType = 0;
static NSString* Default_MoneyPre = @"￥";
static NSString* Default_MoneySuf = @"元";
...
- (NSString *)timeStyle:(int)style
{
    ...
    switch (style) {
        case 0:
        {
            format = [Default_TimeFormat stringByReplacingOccurrencesOfString:@"^" withString:@""];
        }
            break;
        case 1:
        {
...
//    else
//    {
//        CRTimeWrapper* wrapper = [CRTimeWrapper wrapperFromTimeInterval:[self longLongValue]];
//        
//        return wrapper.dateDescription;
//    }
//    
//    return @"数据来源异常";
//}
...
{
    return [self moneyWithUnit:unitType num:2];
}
